...
const DN_SERVICE_DATA: Record<string, { number:string; title:string; price:string; timeline:string; description:string; deliverables:string[] }> = {
  "WEB DEVELOPMENT": {
    number:"01",
    title:"WEB DEVELOPMENT",
    price:"₹8,000 – ₹25,000+",
    timeline:"2–6 WEEKS",
    description:"Premium responsive websites engineered for brands, businesses and personal identities with strong visual direction and reliable performance.",
    deliverables:["Custom UI/UX Design","Responsive Development","SEO Foundation","Performance Optimization","Deployment & Launch"]
  },
  "MOBILE APPLICATIONS": {
    number:"02",
    ...
    price:"₹10,000 – ₹35,000+",
    timeline:"4–10 WEEKS",
    description:"Modern mobile experiences designed around real user journeys, polished interfaces and scalable application architecture.",
    deliverables:["UI/UX Design","Android / iOS Development","API Integration","Authentication","App Deployment"]
  },
  "WEB APPLICATIONS": {
    number:"03",
    ...
    price:"₹12,000 – ₹40,000+",
    timeline:"4–10 WEEKS",
    description:"Custom web applications for dashboards, portals, SaaS products and workflow-driven digital platforms.",
    deliverables:["Product Architecture","Frontend Development","Backend Integration","Database Setup","Deployment"]
  },
  "E-COMMERCE": {
    number:"04",
    title:"E-COMMERCE",
    price:"₹12,000 – ₹30,000+",
    timeline:"3–8 WEEKS",
    description:"Conversion-focused online stores with premium product presentation, checkout flows and scalable commerce foundations.",
    deliverables:["Storefront Design","Product Management","Cart & Checkout","Payment Integration","Order System"]
  },
  "PWA / SYSTEMS": {
    number:"05",
    title:"PWA / SYSTEMS",
    price:"₹15,000 – ₹40,000+",
    timeline:"4–10 WEEKS",
    description:"Installable progressive web experiences and lightweight business systems built for speed, accessibility and cross-device usage.",
    deliverables:["PWA Architecture","Offline Support","Installable Experience","Push Notifications","Performance Optimization"]
  },
  "CUSTOM SOFTWARE": {
    number:"06",
    ...
    price:"₹20,000 – ₹60,000+",
    timeline:"6–14 WEEKS",
    description:"Purpose-built software for unique operational requirements, internal workflows and specialized digital products.",
    deliverables:["Requirement Analysis","System Architecture","Custom Development","Admin Controls","Deployment & Support"]
  }
};

const DN_OPEN_SERVICE = (service: typeof DN_SERVICE_DATA[string]) => {
  window.dispatchEvent(new CustomEvent("dn-service-open", { detail: service }));
};
...
export default function Home() {
    /* DN_SERVICE_CLICK_HANDLER */
  useEffect(() => {
    const handleServiceClick = (event: MouseEvent) => {
      const target = event.target as HTMLElement;
      const row = target.closest(".service-row") as HTMLElement | null;
      if (!row) return;
      ...
      const service = services.find((name) => text.includes(name));
      if (!service) return;
      ...
      const message =
        "Hello DN Studios,\n\n" +
        "I would like to discuss a project for " + service + ". " +
        "Please share the relevant process, estimated investment, expected timeline, " +
        "and the information required to prepare a tailored proposal.\n\n" +
        "Regards,";

      const url =
        "https://wa.me/918780692285?text=" +
...
<section className="letterhead-seal">
        <div className="letterhead-rule"></div>
        <div className="letterhead-core">
...
<section className="dn-contact-band">
        <div>
          <span>DIRECT COMMISSIONS</span>
          <strong>+91 87806 92285</strong>
        </div>
        <div className="dn-contact-band-actions">
          <a href="tel:+918780692285">CALL</a>
          <a href="https://wa.me/918780692285?text=Hello%20DN%20Studios%2C%0A%0AI%20would%20like%20to%20discuss%20a%20digital%20project.%20Please%20share%20your%20process%2C%20estimated%20investment%20and%20the%20next%20steps.%0A%0ARegards%2C" target="_blank" rel="noreferrer">WHATSAPP</a>
        </div>
      </section>
...
<footer className="dn-luxury-footer">
        <div className="dn-footer-top">
          ...
          <div className="dn-footer-actions">
            <a className="dn-footer-call" href="tel:+918780692285">CALL NOW</a>
            <a className="dn-footer-wa" href="https://wa.me/918780692285?text=Hello%20DN%20Studios%2C%0A%0AI%20would%20like%20to%20discuss%20a%20digital%20project.%20Please%20share%20your%20process%2C%20estimated%20investment%20and%20the%20next%20steps.%0A%0ARegards%2C" target="_blank" rel="noreferrer">WHATSAPP</a>
          </div>
        </div>

        <div className="dn-footer-line"></div>

                <div className="dn-footer-bottom">
          <span>DN STUDIOS</span>
          <span className="dn-footer-legal">
